...
public class Employeec {
	...
	public Employeec(String name, int empno, double sal, String desig, String dept,
	...
	public static void main(String[] args) {
		...
		Employeec e = new Employeec(empname, empid, sal, desig, dept, address, mobile, dob, doj);		
